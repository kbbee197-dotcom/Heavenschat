...
export default function Home() {
  ...
  const handleGateEnd = () => goToStage("walkway");
  const choosePath = (path) => goToStage(path);

  return (
    <main className="relative h-screen w-screen overflow-hidden bg-black">
      {/* Preload all videos immediately */}
      <div className="hidden">
        <video src="/videos/walkway-fork.mp4" preload="auto" muted playsInline />
        <video src="/videos/pets-memorial.mp4" preload="auto" muted playsInline />
        <video src="/videos/loved-ones-memorial.mp4" preload="auto" muted playsInline />
      </div>
